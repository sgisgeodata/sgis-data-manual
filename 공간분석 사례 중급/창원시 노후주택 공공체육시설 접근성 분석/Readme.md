...
창원시 1km 격자별 노후주택 수를 시각화하여 노후주택이 집중적으로 분포하는 지역을 확인하였습니다.  
![창원시 노후주택 공공체육시설 접근성 분석](창원시_노후주택_분포.png)


② **공공체육시설 도보·자전거 10분 접근권역**

ORS를 활용하여 창원시 공공체육시설을 기준으로 도보 및 자전거로 10분 이내 접근 가능한 서비스 권역을 구축하였습니다.
![창원시 노후주택 공공체육시설 접근성 분석](공공체육시설_도보10분.png) ![창원시 노후주택 공공체육시설 접근성 분석](공공체육시설_자전거10분.png)

③ **공공체육시설 미도달 노후주택 지역**

공공체육시설 10분 접근권역과 노후주택 격자를 중첩한 결과, 접근권역 밖에 위치하면서 노후주택이 많이 분포하는 지역을 확인할 수 있었습니다.
![창원시 노후주택 공공체육시설 접근성 분석](공공체육시설_미도달영역_노후주택.png)  


## 최종 결과
![창원시 노후주택 공공체육시설 접근성 분석](images/창원시_분석결과.png)  
특히 **창원시 북면**에서는 노후주택 약 **1,101개**, **대산면**에서는 약 **319개**가 집중된 지역이 확인되었습니다. 이를 통해 공공체육시설 접근성이 낮으면서 노후주택이 밀집한 격자지역을 중심으로 체육시설 설치 또는 생활체육 서비스 지원을 검토할 수 있습니다.
