...
# 통계값의 구간 범위 컬럼 만들기
breaks <- c(-24, -15, -10, -1, 1, 10, 15, 21)
labels <- c("-24~-15", "-15~-10", "-10~-1","-1~1","1~10", "10~15", "15~21")
colors <- c("#08519C","#6BAED6","#BDD7E7","#FFFFFF","#FECC5C","#FD8D3C","#BD0026")
