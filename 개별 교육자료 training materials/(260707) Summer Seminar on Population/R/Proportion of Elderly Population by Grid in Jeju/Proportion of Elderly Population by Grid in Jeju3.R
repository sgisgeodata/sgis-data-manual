source("./Proportion of Elderly Population by Grid in Jeju_lib.R", encoding="UTF-8")
...
# 지도를 그림파일로 저장
file_path <- paste(prj_dir, "Proportion of Elderly Population by Grid in Jeju_GRID.png", sep="/")
